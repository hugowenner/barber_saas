...
import { MOCK_CLIENTS } from "@/data/admin/clients";
                ...
                {filtered.map((c) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-muted-foreground">
                      {c.lastVisitAt ? formatDateShort(c.lastVisitAt) : "—"}
                    </td>
                    <td className="px-4 py-3 text-right tabular-nums text-foreground">
                      {c.totalAppointments}
                    </td>
                    <td className="px-4 py-3">
                      <ClientStatusPill active={c.isActive} />
                    </td>
            ...
            {filtered.map((c) => (
              <li key={c.id}>
                <Link
                  ...
                  className="flex items-center gap-3 rounded-lg border border-border bg-card p-4 transition-colors hover:border-primary/40 focus-ring"
                >
